...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    return (
      <div className={cn("font-medium", labelClassName)}>{renderedValue}</div>
    )
  }, [
    label,
    labelFormatter,
                  ...
                  <>
                    ...
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        {(() => {
                          const rawLabel = itemConfig?.label ?? item.name
                          const renderedLabel = React.isValidElement(rawLabel)
                            ? rawLabel
                            : typeof rawLabel === "function"
                              ? React.createElement(
                                  rawLabel as React.ComponentType
                                )
                              : rawLabel
                          return (
