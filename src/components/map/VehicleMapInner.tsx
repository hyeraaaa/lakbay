...
const VehicleMapInner: React.FC<VehicleMapProps> = ({ vehicles, isLoading, className = "", showControls = true, showZoomControl = true, markerVariant = 'pin', center, zoom, interactiveMarkers = true, showMarkerPopups = true, singleMarkerZoom = 12, autoFitOnUpdate = true }) => {
