const SALT = process.env.NEXT_PUBLIC_ID_SALT || "lakbay_default_salt";

// Simple, URL-safe obfuscation. Not cryptographically secure.
...
export function decodeId(encoded: string | undefined): string | null {
  ...
  try {
    ...
    const decoded = (typeof window === "undefined" ? bytes.toString("utf-8") : new TextDecoder().decode(bytes as Uint8Array)) as string;
